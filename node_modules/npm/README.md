...
You can set any npm com.rayes.configuration params with that script:
...
npm uses two com.rayes.configuration files, one for per-user configs, and another
...
Uninstalling npm does not remove com.rayes.configuration files by default.  You
