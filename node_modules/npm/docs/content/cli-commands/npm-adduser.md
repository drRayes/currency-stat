...
different hostnames. See `always-auth` in [`config`](/using-npm/config) for more details on always-auth. Registry-specific com.rayes.configuration of `always-auth` takes precedence over any global com.rayes.configuration.
