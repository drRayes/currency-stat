...
For a list of available com.rayes.configuration options, see [config](/using-npm/config).
...
This is an unchangeable "builtin" com.rayes.configuration file that npm keeps
