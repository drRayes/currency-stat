...
A "config" object can be used to set com.rayes.configuration parameters used in package
...
com.rayes.configuration param.  See [`config`](/using-npm/config) for more on the topic.
