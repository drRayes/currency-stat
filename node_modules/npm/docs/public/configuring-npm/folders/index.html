...
<p>This is controlled by the <code class="language-text">cache</code> com.rayes.configuration param.</p>
...
<p>If the <code class="language-text">global</code> com.rayes.configuration is set to true, then npm will
