...
<p>A "config" object can be used to set com.rayes.configuration parameters used in package
...
com.rayes.configuration param.  See <a href="../../using-npm/config"><code class="language-text">config</code></a> for more on the topic.</p>
