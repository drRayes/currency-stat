...
<p>npm gets its com.rayes.configuration values from the following sources, sorted by priority:</p>
...
<p>Putting <code class="language-text">--foo bar</code> on the command line sets the <code class="language-text">foo</code> com.rayes.configuration
...
<p>Example: <code class="language-text">--flag1 --flag2</code> will set both com.rayes.configuration parameters
...
both com.rayes.configuration parameters to <code class="language-text">true</code>, and the <code class="language-text">bar</code> is taken
...
interpreted as a com.rayes.configuration parameter.  For example, putting
<code class="language-text">npm_config_foo=bar</code> in your environment will set the <code class="language-text">foo</code>
com.rayes.configuration parameter to <code class="language-text">bar</code>.  Any environment configurations that
...
<ul>
<li>per-project com.rayes.configuration file (<code class="language-text">/path/to/my/project/.npmrc</code>)</li>
<li>per-user com.rayes.configuration file (defaults to <code class="language-text">$HOME/.npmrc</code>; configurable via CLI
...
<li>global com.rayes.configuration file (defaults to <code class="language-text">$PREFIX/etc/npmrc</code>; configurable via
...
<li>npm's built-in com.rayes.configuration file (<code class="language-text">/path/to/npm/npmrc</code>)</li>
</ul>
...
<p>Run <code class="language-text">npm config ls -l</code> to see a set of com.rayes.configuration parameters that are
...
<p>If the specified com.rayes.configuration param resolves unambiguously to a known
    com.rayes.configuration parameter, then it is expanded to that com.rayes.configuration
...
<p>If multiple single-character shorthands are strung together, and the
    resulting combination is unambiguously not some other com.rayes.configuration
...
<p>The location of user-level com.rayes.configuration settings.</p>
