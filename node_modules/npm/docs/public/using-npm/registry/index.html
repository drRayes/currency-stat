...
<a href="../../configuring-npm/npmrc"><code class="language-text">npmrc</code></a>, and <a href="../../using-npm/config"><code class="language-text">config</code></a> for more on managing npm's com.rayes.configuration.</p>
