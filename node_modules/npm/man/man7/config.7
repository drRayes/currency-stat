...
.SH "NAME"
\fBconfig\fR \- More than you probably want to know about npm com.rayes.configuration
.SS Description
.P
npm gets its com.rayes.configuration values from the following sources, sorted by priority:
.SS Command Line Flags
.P
Putting \fB\-\-foo bar\fP on the command line sets the \fBfoo\fP com.rayes.configuration
...
.P
Example: \fB\-\-flag1 \-\-flag2\fP will set both com.rayes.configuration parameters
...
both com.rayes.configuration parameters to \fBtrue\fP, and the \fBbar\fP is taken
...
com.rayes.configuration parameter to \fBbar\fP\|\.  Any environment configurations that
...
.RS 0
.IP \(bu 2
per\-project com.rayes.configuration file (\fB/path/to/my/project/\.npmrc\fP)
.IP \(bu 2
per\-user com.rayes.configuration file (defaults to \fB$HOME/\.npmrc\fP; configurable via CLI
option \fB\-\-userconfig\fP or environment variable \fB$NPM_CONFIG_USERCONFIG\fP)
.IP \(bu 2
global com.rayes.configuration file (defaults to \fB$PREFIX/etc/npmrc\fP; configurable via
CLI option \fB\-\-globalconfig\fP or environment variable \fB$NPM_CONFIG_GLOBALCONFIG\fP)
.IP \(bu 2
npm's built\-in com.rayes.configuration file (\fB/path/to/npm/npmrc\fP)
...
.SS Default Configs
.P
Run \fBnpm config ls \-l\fP to see a set of com.rayes.configuration parameters that are
