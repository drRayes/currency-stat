...
Install tools and com.rayes.configuration manually:
...
A `binding.gyp` file describes the com.rayes.configuration to build your module, in a
...
Some additional resources for Node.js native addons and writing `gyp` com.rayes.configuration files:
