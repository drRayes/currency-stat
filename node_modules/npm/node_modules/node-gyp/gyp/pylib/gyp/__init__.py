...
def gyp_main(args):
  ...
  parser.add_argument('--build', dest='configs', action='append',
                    help='com.rayes.configuration for build after project generation')
  parser.add_argument('--check', dest='check', action='store_true',
                    help='check format of gyp files')
  parser.add_argument('--config-dir', dest='config_dir', action='store',
                    env_name='GYP_CONFIG_DIR', default=None,
                    help='The location for com.rayes.configuration files like '
                    'include.gypi.')
  ...
  # doesn't support this com.rayes.configuration. Libtool on Mac also generates warnings
  ...
  # Set up the com.rayes.configuration directory (defaults to ~/.gyp)
