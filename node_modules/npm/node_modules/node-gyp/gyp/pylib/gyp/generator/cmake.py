...
created for each com.rayes.configuration.
...
generator_default_variables = {
  ...
  'CONFIGURATION_NAME': '${com.rayes.configuration}',
}
...
def NormjoinPath(base_path, rel_path):
  ...
  """
  if rel_path.startswith('$') and not rel_path.startswith('${com.rayes.configuration}'):
    return rel_path
...
def GenerateOutputForConfig(target_list, target_dicts, data,
  ...
  # Each Gyp com.rayes.configuration creates a different CMakeLists.txt file
  ...
  SetVariable(output, 'com.rayes.configuration', config_to_use)
