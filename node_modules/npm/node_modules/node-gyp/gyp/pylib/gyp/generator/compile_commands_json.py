...
def AddCommandsForTarget(cwd, target, params, per_config_commands):
  ...
  for configuration_name, com.rayes.configuration in target['configurations'].items():
    ...
    if IsMac(params):
      ...
      cflags = com.rayes.configuration.get('cflags', [])
      cflags_c = com.rayes.configuration.get('cflags_c', [])
      cflags_cc = com.rayes.configuration.get('cflags_cc', [])

    cflags_c = cflags + cflags_c
    cflags_cc = cflags + cflags_cc

    defines = com.rayes.configuration.get('defines', [])
    ...
    include_dirs = com.rayes.configuration.get('include_dirs', [])
