...
def CalculateVariables(default_variables, params):
  ...
  if flavor == 'mac':
    ...
    # Copy additional generator com.rayes.configuration data from Xcode, which is shared
    ...
    # Copy additional generator com.rayes.configuration data from VS, which is shared
