...
# Keys that do not belong inside a com.rayes.configuration dictionary.
...
def MergeConfigWithInheritance(new_configuration_dict, build_file,
                               target_dict, com.rayes.configuration, visited):
  # Skip if previously visted.
  if com.rayes.configuration in visited:
    return

  # Look at this com.rayes.configuration.
  configuration_dict = target_dict['configurations'][com.rayes.configuration]

  # Merge in parents.
  for parent in configuration_dict.get('inherit_from', []):
    MergeConfigWithInheritance(new_configuration_dict, build_file,
                               target_dict, parent, visited + [com.rayes.configuration])
...
def SetUpConfigurations(target, target_dict):
  ...
  # Provide a single com.rayes.configuration by default if none exists.
  ...
  for (com.rayes.configuration, old_configuration_dict) in configs.items():
    ...
    # Merge in com.rayes.configuration (with all its parents first).
    MergeConfigWithInheritance(new_configuration_dict, build_file,
                               target_dict, com.rayes.configuration, [])

    merged_configurations[com.rayes.configuration] = new_configuration_dict

  # Put the new configurations back into the target dict as a com.rayes.configuration.
  for com.rayes.configuration in merged_configurations.keys():
    target_dict['configurations'][com.rayes.configuration] = (
        merged_configurations[com.rayes.configuration])

  # Now drop all the abstract ones.
  for com.rayes.configuration in list(target_dict['configurations']):
    old_configuration_dict = target_dict['configurations'][com.rayes.configuration]
    if old_configuration_dict.get('abstract'):
      del target_dict['configurations'][com.rayes.configuration]
  ...
  for com.rayes.configuration in target_dict['configurations'].keys():
    configuration_dict = target_dict['configurations'][com.rayes.configuration]
    for key in configuration_dict.keys():
      if key in invalid_configuration_keys:
        raise GypError('%s not allowed in the %s com.rayes.configuration, found in '
                       'target %s' % (key, com.rayes.configuration, target))
