...
class MsvsSettings(object):
  ...
  def GetArch(self, config):
    ...
    if not platform: # If no specific override, use the com.rayes.configuration's.
      platform = configuration_platform
    # Map from platform to architecture.
    return {'Win32': 'x86', 'x64': 'x64', 'ARM64': 'arm64'}.get(platform, 'x86')

  def _TargetConfig(self, config):
    """Returns the target-specific com.rayes.configuration."""
    # There's two levels of architecture/platform specification in VS. The
    # first level is globally for the com.rayes.configuration (this is what we consider
    # "the" config at the gyp level, which will be something like 'Debug' or
    # 'Release_x64'), and a second target-specific com.rayes.configuration, which is an
    # override for the global one. |config| is remapped here to take into
    # account the local target-specific overrides to the global com.rayes.configuration.
...
<trustInfo xmlns="urn:schemas-microsoft-com:asm.v3">
  ...
  def GetIdlBuildData(self, source, config):
    ...
    variables = [('tlb', tlb),
                 ...
                 ('iid', iid),
                 ('proxy', proxy)]
    # TODO(scottmg): Are there com.rayes.configuration settings to set these flags?
