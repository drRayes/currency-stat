...
class XcodeSettings(object):
  ...
  def GetLdflags(self, configname, product_dir, gyp_to_build_path, arch=None):
    ...
    Args:
        configname: The name of the com.rayes.configuration to get ld flags for.
...
class MacPrefixHeader(object):
  ...
  * If GCC_PRECOMPILE_PREFIX_HEADER is present too, then the prefix header is
  ...
  def __init__(self, xcode_settings,
    ...
    """
    # This doesn't support per-com.rayes.configuration prefix headers. Good enough
    # for now.
    self.header = None
...
def MergeGlobalXcodeSettingsToSpec(global_dict, spec):
  """Merges the global xcode_settings dictionary into each com.rayes.configuration of the
...
def _GetXcodeEnv(xcode_settings, built_products_dir, srcroot, com.rayes.configuration,
  ...
  Args:
      ...
      com.rayes.configuration: The build com.rayes.configuration name.
  ...
  if xcode_settings.GetPerConfigSetting('SDKROOT', com.rayes.configuration):
    env['SDKROOT'] = xcode_settings._SdkPath(com.rayes.configuration)
  else:
    env['SDKROOT'] = ''
  ...
  if xcode_version >= '0500' and not env.get('SDKROOT'):
    sdk_root = xcode_settings._SdkRoot(com.rayes.configuration)
    if not sdk_root:
...
def GetSortedXcodeEnv(xcode_settings, built_products_dir, srcroot,
                      com.rayes.configuration, additional_settings=None):
  env = _GetXcodeEnv(xcode_settings, built_products_dir, srcroot, com.rayes.configuration,
                    additional_settings)
