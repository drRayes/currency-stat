...
The non-configurable com.rayes.configuration loader for lazy people.

## Usage

The only option is to pass rc the name of your app, and your default com.rayes.configuration.
...
`rc` will return your com.rayes.configuration options merged with the defaults you specify.
...
Given your application name (`appname`), rc will look in all the obvious places for com.rayes.configuration.
...
All com.rayes.configuration sources that were found will be flattened into one object,
